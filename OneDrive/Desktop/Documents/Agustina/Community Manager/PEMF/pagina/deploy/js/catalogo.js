...
const PRODUCTS = [
  ...
  { brand: 'lifewave', name: 'AEON', badge: 'Calma', badgeBg: '#f0e8f1', badgeColor: '#7c3aed', price: '$150.000', priceDay: '$5.000/día', stock: '30 parches', stockCount: 9, stockStatus: '9 en stock', img: 'img/productos/lifewave/aeon.png', goals: ['longevidad', 'inmunidad'], desc: 'Reducí el estrés, mejoró tu claridad mental.' },
  ...
  // NEURO
  { brand: 'neuro', name: 'Neuro Gum Focus', badge: 'Foco', badgeBg: '#d1fae5', badgeColor: '#065f46', price: '$85.000', priceDay: '$2.833/día', stock: '30 gomas', stockCount: 15, stockStatus: '15 en stock', img: 'img/productos/neuro/neurogum.png', goals: ['foco'], desc: 'Nootrópicos en formato goma para máximo foco.' },
  { brand: 'neuro', name: 'Neuro Gum Sleep', badge: 'Sueño', badgeBg: '#d1fae5', badgeColor: '#065f46', price: '$85.000', priceDay: '$2.833/día', stock: '30 gomas', stockCount: 10, stockStatus: '10 en stock', img: 'img/productos/neuro/neurogum.png', goals: ['sueno'], desc: 'Gomas nootrópicas para sueño reparador y calidad.' },
